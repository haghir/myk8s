...
{{/*
Create the name of the volume that will be mounted on the html directory.
*/}}
{{- define "wordpress.storages.html.name" -}}
{{- printf "%s-storage-html" (include "wordpress.fullname" .) -}}
{{- end -}}
